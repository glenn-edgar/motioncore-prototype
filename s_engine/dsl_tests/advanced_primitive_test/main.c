...
#include "advanced_primitive_test_bin_32.h"
#include "advanced_primitive_test_records.h"

extern void advanced_primitive_test_register_all(s_expr_module_t* module);
...
static void register_user_functions(s_engine_handle_t* engine) {
    advanced_primitive_test_register_all(&engine->module);
}
...
int main(int argc, char* argv[]) {
    ...
    bool result = s_engine_load_from_rom(
        &engine,
        &alloc,
        advanced_primitive_test_module_bin_32,
        ADVANCED_PRIMITIVE_TEST_MODULE_BIN_32_SIZE,
        debug_callback,
        1,
        user_fns
    );
    ...
    result = s_engine_load_from_file(
        &engine,
        &alloc,
        "advanced_primitive_test_32.bin",
        debug_callback,
        1,
        user_fns
    );
