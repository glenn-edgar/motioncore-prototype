// main_rom.c — loop_test via M-port const-ROM path
#define _GNU_SOURCE
#include <time.h>
#include <stdio.h>
#include <stdlib.h>
...
extern const s_engine_rom_t loop_test_module_rom;
...
int main(void) {
    ...
    s_expr_tree_instance_t* tree = s_expr_tree_create_by_hash(&module, LOOP_TEST_HASH, 0);
