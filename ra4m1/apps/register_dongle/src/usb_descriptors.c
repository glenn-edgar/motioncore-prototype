// ============================================================================
// usb_descriptors.c — register_dongle (Seeed XIAO RA4M1). Single CDC interface.
// Ported from the blink_frame RA4M1 descriptors; only the PID and the product
// strings differ.
// ============================================================================
...
// motioncore VID:PID. 0x2886 = Seeed vendor range. RA4M1 app PID allocation:
//   0x0049 stock XIAO RA4M1   0x0050 hello_cdc   0x0051 blink_engine
//   0x0052 blink_frame        0x0053 register_dongle  <- this app
...
static char const* const string_desc_arr[] = {
    ...
    [STR_PRODUCT]      = "ra4m1_register_dongle",
    [STR_SERIAL]       = NULL,                          // filled from chip UID
    [STR_CDC_ITF]      = "ra4m1_register_dongle CDC",
};
