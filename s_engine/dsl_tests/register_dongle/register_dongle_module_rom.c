// ============================================================================
// register_dongle_module_rom.c
// Generated S-expression module for register_dongle (M-port: const ROM tables)
...
// Tree: register_dongle (params=28, nodes=9)
static const s_expr_param_t register_dongle_register_dongle_params[] = {
    { .type = 0x07, .index_to_pointer = 0, .brace_idx = 27, .parent_offset = 0 },
    ...
    { .type = 0x07, .index_to_pointer = 0, .brace_idx = 18, .parent_offset = 4 },
    ...
    { .type = 0x07, .index_to_pointer = 0, .brace_idx = 2, .parent_offset = 1 },
    { .type = 0x08, .index_to_pointer = 0, .node_index = 4, .func_index = 1 },
    { .type = 0x06, .index_to_pointer = 0, .brace_idx = 2, .parent_offset = 3 },
    { .type = 0x07, .index_to_pointer = 0, .brace_idx = 3, .parent_offset = 4 },
    { .type = 0x89, .index_to_pointer = 0, .node_index = 5, .func_index = 3 },
    ...
    { .type = 0x09, .index_to_pointer = 0, .node_index = 6, .func_index = 4 },
    ...
    { .type = 0x06, .index_to_pointer = 0, .brace_idx = 18, .parent_offset = 22 },
    ...
    { .type = 0x06, .index_to_pointer = 0, .brace_idx = 27, .parent_offset = 0 }
};

// Tree definitions
static const s_expr_tree_def_t register_dongle_trees[] = {
    {
        .name_hash = 0xBAEA04D8U,
        .record_hash = 0U,
        .params = register_dongle_register_dongle_params,
        .param_count = 28,
        .func_node_count = 9,
        .pointer_count = 1,
...
static const s_expr_oneshot_fn_t register_dongle_oneshot_fns[] = {
    send_register,  // 0: send_register
    send_heartbeat  // 1: send_heartbeat
};

static const s_expr_main_fn_t register_dongle_main_fns[] = {
    se_function_interface,  // 0: SE_FUNCTION_INTERFACE
    se_fork,  // 1: SE_FORK
    se_chain_flow,  // 2: SE_CHAIN_FLOW
    se_tick_delay,  // 3: SE_TICK_DELAY
    se_return_pipeline_reset,  // 4: SE_RETURN_PIPELINE_RESET
    toggle_led,  // 5: toggle_led
    se_return_halt  // 6: SE_RETURN_HALT
};

static const s_expr_pred_fn_t register_dongle_pred_fns[1] = { NULL };

// Top-level ROM handle (M-port)
const s_engine_rom_t register_dongle_module_rom = {
    .name_hash = 0xBAEA04D8U,
    .is_64bit = false,
    .trees = register_dongle_trees,
    .tree_count = 1,
    .records = NULL,
    .record_count = 0,
    .string_table = NULL,
    ...
    .constants = NULL,
    .const_count = 0,
    .oneshot_fns = register_dongle_oneshot_fns,
    .oneshot_count = 2,
    .main_fns = register_dongle_main_fns,
    .main_count = 7,
    .pred_fns = register_dongle_pred_fns,
    .pred_count = 0,
