// ============================================================================
// usb_descriptors.c — blink_engine (Seeed XIAO RA4M1). Single CDC interface.
// ============================================================================

#include "bsp/board_api.h"
#include "tusb.h"

// motioncore VID:PID. 0x2886 = Seeed vendor range. 0x0051 picked distinct from
// the stock XIAO RA4M1 app (0x0049) and hello_cdc (0x0050).
...
static char const* const string_desc_arr[] = {
    ...
    [STR_PRODUCT]      = "ra4m1_blink_engine",
    [STR_SERIAL]       = NULL,                          // filled from chip UID
    [STR_CDC_ITF]      = "ra4m1_blink_engine CDC",
};
